...
#SBATCH -o slurm_outfiles/resample_checkvar.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/resample_checkvar.err # name of error file for this submission script

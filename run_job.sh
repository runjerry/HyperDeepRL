...
#SBATCH -o slurm_outfiles/p24_sample_sgd_3.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/p24_sample_sgd_3.err # name of error file for this submission script

...
#SBATCH -o slurm_outfiles/episodic_update_target2.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/episodic_update_target2.err # name of error file for this submission script

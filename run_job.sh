...
#SBATCH -o slurm_outfiles/rand00_p24_baseline3.out # name of output file for this submission script
#SBATCH -e slurm_outfiles/rand00_p24_baseline3.err # name of error file for this submission script
